...
--
-- Dumping data for table `bocadillo`
--

LOCK TABLES `bocadillo` WRITE;
/*!40000 ALTER TABLE `bocadillo` DISABLE KEYS */;
/*!40000 ALTER TABLE `bocadillo` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `tomato` WRITE;
/*!40000 ALTER TABLE `tomato` DISABLE KEYS */;
/*!40000 ALTER TABLE `tomato` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-10-12  9:02:01
